...
def handle_text(message):
    if message.text=='💬 Начать 💬':
        ...
        'Holy Transaction \n'
        'По мнению многих специалистов наиболее надежный и удобный для начинающих кошелек.Он поддерживает 9 криптовалют и практически бесплатен.\n\n'
        'Coinomi\n'
        'Второй по популярности сервис.Бесплатен, основан на открытом коде, имеет внушительный список 43 криптовалют.\n\n'
        'CoinsBank\n'
        'Новый, но любопытный сервис.Поддерживает 9 криптовалют, предлагает  свою трейдинговую платформу, мобильные приложения и решения для электронной торговли.\n\n'
        'BIT.AC\n'
        'Запущенный в марте 2016 года мультивалютный криптокошелек: 15 валют, судя по данным в личном кабинете, хвалят за неплохие курсы обмена реферальную программу, дающую до 50% отчислений.\n\n'
        'Micelium\n'
        'это только мобильное приложение, которое можно установить на Android и IOS. Оно набрало весомую популярность у пользователей сообщества Bitcoin.\n\n'
        'BitGo\n'
        'Биткойн-кошелек BitGo дает клиентам возможность проведения мгновенных Биткойн-платежей через блокчейн-хранилище. А высокая скорость проведения операций не оставила никого равнодушным!\n\n'
        'Airbitz\n'
        'Airbitz – очень удобный биткоин-кошелек. Airbitz надежное средство, предназначается для хранения, последующей продажи или покупки биткоинов, которое работает прямо в приложении. \n\n'
        'Copay\n'
        'Copay – Этот кошелек реально отличается от всего того, что мы видели ранее - начиная от интерфейса и заканчивая обилием настроек. Пока Copay поддерживает только Bitcoin и не имеет никаких планов по подключению альткоинов. \n\n' ,reply_markup=keyboard)
        ...
        keyboard = types.InlineKeyboardMarkup()
        url_button = types.InlineKeyboardButton(text="Перейти к платному боту", url="https://telegram.me/cryptonowcoin_bot")
        keyboard.add(url_button)
