...
def handle_help(message):
    ...
    url_button = types.InlineKeyboardButton(text="Написать в техподдержку", url="https://telegram.me/infahelp")
...
def handle_menu(message):
    ...
    user_markup.row('☎ Контакты ☎', '💎 НАЧАТЬ ЗАРАБАТЫВАТЬ')
...
def handle_text(message):
    if message.text=='💬 Начать 💬':
        ...
        keyboard = types.InlineKeyboardMarkup()
        url_button = types.InlineKeyboardButton(text="Перейти к платному боту", url="https://telegram.me/infatrade_bot")
        keyboard.add(url_button)
        ...
        keyboard = types.InlineKeyboardMarkup()
        url_button = types.InlineKeyboardButton(text="Канал infa Plus в Telegram", url="https://telegram.me/infaplus")
        url_button1= types.InlineKeyboardButton(text="Сайт infa Plus", url="https://infa.plus")
        keyboard.add(url_button)
        keyboard.add(url_button1)
        ...
        bot.send_message(message.chat.id,'Последовательность ваших действий:\n\n'
                                         '1. Регистрация Биткоин кошелька 🔒\n'
                                            ...
                                            '7. Следить за сервисом infa Plus 👀\n'
                                            '8. Вывод Прибыли 💸\n')
    else:
